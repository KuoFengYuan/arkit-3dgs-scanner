...
for test in test_fusion_memory_pressure test_stop_processing test_fusion_export test_large_scan_memory test_lidar_consistency test_range_priority test_surface_coverage; do
