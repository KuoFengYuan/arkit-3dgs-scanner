...
sources=(arkit-3dgs-scanner/Capture/{Localization,Models,BlurFilter,CaptureConfig,DepthSampleFilter,RefusionEngine,SurfaceTSDF,ExportManager,TrainingFrameSelector,OfflinePoseRefinement,LocalSurfaceRefiner,LoopClosureRefiner,FeatureTracker,BundleAdjuster,PoseRefiner,PhotometricPoseValidator,SceneMetricScale}.swift arkit-3dgs-scanner/History/{ScanLibrary,ScanLibrary+Metrics}.swift)
for test in test_loop_closure test_revisit_tracks test_metric_scale; do
